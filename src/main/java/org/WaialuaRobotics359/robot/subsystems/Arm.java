...
public class Arm extends SubsystemBase{
   ...
   // private TalonFX m_rArm;
    ...
    public Arm(){
      ...
      //  m_rArm.setSelectedSensorPosition(0);
      //  m_rArm.configFactoryDefault();
      //  m_rArm.configMotionCruiseVelocity(15000);
      //  m_rArm.configMotionAcceleration(30000);
      //  m_rArm.configMotionSCurveStrength(6);
