...
public class Bump3Balance extends SequentialCommandGroup {

    public Bump3Balance (SwerveAutoBuilder autoBuilder, PoseEstimator s_poseEstimator) {
        ...
        PathPlannerTrajectory AutoPath4 = PathPlanner.loadPath("Bump3Balance", new PathConstraints(4, 3));
