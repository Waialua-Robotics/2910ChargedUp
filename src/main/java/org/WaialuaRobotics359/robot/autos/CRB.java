...
public class CRB extends SequentialCommandGroup {

    public CRB (SwerveAutoBuilder autoBuilder, PoseEstimator s_poseEstimator) {
        ...
        PathPlannerTrajectory AutoPath4 = PathPlanner.loadPath("CRB", new PathConstraints(4, 3));
