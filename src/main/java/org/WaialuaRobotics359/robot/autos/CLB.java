...
public class CLB extends SequentialCommandGroup {

    public CLB (SwerveAutoBuilder autoBuilder, PoseEstimator s_poseEstimator) {
        ...
        PathPlannerTrajectory AutoPath4 = PathPlanner.loadPath("CLB", new PathConstraints(4, 3));
