...
public class YoshiPickupAuto extends CommandBase{
    private Arm s_Arm;
    ...
    public YoshiPickupAuto(Arm s_Arm, Intake s_Intake, Flight s_Flight, Wrist s_Wrist, Leds s_Leds, Pivot s_Pivot){
        this.s_Arm = s_Arm;
    ...
    public void initialize(){
        if (RobotContainer.isCube){
            ArmPosition = Constants.Arm.Cube.yoshiPosition;
