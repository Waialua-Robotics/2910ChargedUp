...
import org.WaialuaRobotics359.robot.commands.AutoCommands.YoshiPickupAuto;
...
public class YoshiPickupStow extends SequentialCommandGroup {

    public YoshiPickupStow (Intake s_Intake, Arm s_Arm, Wrist s_Wrist, Pivot s_Pivot, Leds s_Leds, Flight s_Flight) {


        addCommands(new SequentialCommandGroup(
            new YoshiPickupAuto(s_Arm, s_Intake, s_Flight , s_Wrist, s_Leds, s_Pivot),
