...
public class Upright extends CommandBase{
    ...
    public Upright(Intake s_Intake, Arm s_Arm, Leds s_Leds, Flight s_Flight, Wrist s_Wrist, Pivot s_Pivot){
        this.s_Arm = s_Arm;
        this.s_Leds = s_Leds;
    ...
    public void initialize(){
        ...
        ArmPosition = Constants.Arm.middleStowPosition;
        PivotPosition = Constants.Pivot.middleStowPosition;
        WristPosition = Constants.Wrist.middleStowPosition;
